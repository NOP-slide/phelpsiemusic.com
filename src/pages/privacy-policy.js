...
const PrivacyPolicyPage = () => (
  <Layout>
    <div className="max-w-xs mx-auto my-12 md:max-w-6xl">
      <h1 className="text-4xl font-bold text-brand-teal">Privacy Policy</h1>
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Interpretation</h2>
      <p className="mt-6 text-white">
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Definitions</h2>
      <p className="mt-6 text-white">
        ...
        <ul className="list-disc">
          ...
          <li>
            ...
            this Agreement) refers to Phelpsie Music.
          </li>
          <li>
          ...
          <li>
            Website refers to Phelpsie Music, accessible from
            https://phelpsiemusic.com{" "}
          </li>
          <li>
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Personal Data</h2>
      <p className="mt-6 text-white">
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Usage Data</h2>
      <p className="mt-6 text-white">
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Law enforcement</h2>
      <p className="mt-6 text-white">
      ...
      <br />
      <h2 className="text-3xl font-bold text-brand-teal">Children's Privacy</h2>
      <p className="mt-6 text-white">
